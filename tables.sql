...
CREATE TABLE SiteBooking (
    ...
    RequestedStartDATETIMEOFFSET DATETIMEOFFSETTIMEOFFSET NOT NULL,
    RequestedEndDATETIMEOFFSET DATETIMEOFFSETTIMEOFFSET NOT NULL,
    RequestContactId UNIQUEIDENTIFIER NOT NULL,
    RequestCreationDATETIMEOFFSET DATETIMEOFFSETTIMEOFFSET NOT NULL,
    ApprovalDATETIMEOFFSET DATETIMEOFFSETTIMEOFFSET NULL,
    ApprovedByContactId UNIQUEIDENTIFIER,
    Notes NVARCHAR(255) NULL,
    FulfillmentDATETIMEOFFSET DATETIMEOFFSETTIMEOFFSET NULL,
    FOREIGN KEY (SiteId) REFERENCES Site(ID),
...
CREATE TABLE SiteRestriction (
    ID UNIQUEIDENTIFIER PRIMARY KEY,
    SiteId UNIQUEIDENTIFIER,
    RestrictionStartDATETIMEOFFSET DATETIMEOFFSET,
    RestrictionEndDATETIMEOFFSET DATETIMEOFFSET,
    ApprovalDATETIMEOFFSET DATETIMEOFFSET,
    ApprovalContactId UNIQUEIDENTIFIER,
    IsPowerAffected BOOLEAN,
    IsUtilitiesAffected BOOLEAN,
    Notes NVARCHAR(2000),
    FOREIGN KEY (SiteId) REFERENCES Site(ID),
);
